...
{
    $name1 = $_POST['nameOfComplainant'];
    $PhNo1 = $_POST['PhnoOfComplainant'];
    $name2 = $_POST['nameOfComplainant2'];
    $PhNo2 = $_POST['PhnoOfComplainant2'];
    ...
    $sql = "INSERT INTO community(Complainant1Name,Complainant1PhNo,Complainant2Name,Complainant2PhNo,Municipality,Address,CATEGORY,Description,ReportedEarlier,NoActionDays)
    VALUES('$name1','$PhNo1','$name2','$PhNo2','$municipality','$Address','$category','$desc','$reported','$daysPassed')";
...
<html>
<head>
    <title>COMMUNITY COMPLAINT FORM</title>
    <link rel="stylesheet" href="css/communityForm.css">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    </head>
    <body>
    
        <div class="container topHead">
        <h1 class="display-4">Community Complaint Form</h1>
        </div>
        ...
        <div class="form-group">
            <label for="nameOfComplainant2" class="required">Name of the other complainant:</label>
            <input type="text" class="form-control" id="nameOfComplainant2" name="nameOfComplainant2" placeholder="Enter name" required >
         </div>
            
        <div class="form-group">
            <label for="PhnoOfComplainant2" class="required">Contact number of the other complainant:</label>
            <input type="text" class="form-control" id="PhnoOfComplainant2" name="PhnoOfComplainant2" placeholder="Enter contact number" required>
         </div>
